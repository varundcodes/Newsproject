...
urlpatterns = [
    ...
    path("test-invoice/", views.test_invoice, name="test_invoice"),
    path("bulk-send-invoice/", views.bulk_send_invoice, name="bulk_send_invoice"),
    path("uploaded-payments/", views.uploaded_payments, name="uploaded_payments"),
    # Payments
    ...
    path("test-whatsapp/", views.test_whatsapp),
]
